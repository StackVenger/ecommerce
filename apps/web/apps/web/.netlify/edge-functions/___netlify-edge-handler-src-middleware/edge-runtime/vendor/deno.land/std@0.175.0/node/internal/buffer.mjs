...
Buffer.prototype.readBigUint64LE = Buffer.prototype.readBigUInt64LE = defineBigIntMethod(
...
Buffer.prototype.writeBigUint64LE = Buffer.prototype.writeBigUInt64LE = defineBigIntMethod(
  function writeBigUInt64LE(value, offset = 0) {
    return wrtBigUInt64LE(this, value, offset, BigInt(0), BigInt('0xffffffffffffffff'));
  },
);

Buffer.prototype.writeBigUint64BE = Buffer.prototype.writeBigUInt64BE = defineBigIntMethod(
...
export const encodingOps = {
  ascii: {
    ...
    indexOf: (buf, val, byteOffset, dir) =>
      indexOfBuffer(buf, asciiToBytes(val), byteOffset, encodingsMap.ascii, dir),
  ...
  base64: {
    ...
    indexOf: (buf, val, byteOffset, dir) =>
      indexOfBuffer(buf, base64ToBytes(val), byteOffset, encodingsMap.base64, dir),
  ...
  base64url: {
    ...
    indexOf: (buf, val, byteOffset, dir) =>
      indexOfBuffer(buf, base64UrlToBytes(val), byteOffset, encodingsMap.base64url, dir),
  ...
  latin1: {
    ...
    indexOf: (buf, val, byteOffset, dir) =>
      indexOfBuffer(buf, asciiToBytes(val), byteOffset, encodingsMap.latin1, dir),
  ...
  ucs2: {
    ...
    indexOf: (buf, val, byteOffset, dir) =>
      indexOfBuffer(buf, utf16leToBytes(val), byteOffset, encodingsMap.utf16le, dir),
  ...
  utf8: {
    ...
    indexOf: (buf, val, byteOffset, dir) =>
      indexOfBuffer(buf, utf8Encoder.encode(val), byteOffset, encodingsMap.utf8, dir),
...
export function _copyActual(source, target, targetStart, sourceStart, sourceEnd) {
