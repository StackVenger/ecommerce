...
> = undefined extends (false extends TBooleans ? undefined : TBooleans) & TCollectable & TStrings
  ? false
  : true;
...
type AliasNames<TArgName, TAliases extends Aliases | undefined> = TArgName extends keyof TAliases
  ...
  : TArgs extends Record<string, unknown>
    ? Omit<TArgs, keyof TDefaults> & {
        [Default in keyof TDefaults]: Default extends keyof TArgs
          ? (TArgs[Default] & TDefaults[Default]) | TDefaults[Default] extends Record<
              string,
              unknown
            >
  ...
  Extract<TArgNames, TCollectable> extends string
    ? (Exclude<TArgNames, TCollectable> extends never
        ...
        (Extract<TArgNames, TCollectable> extends never
          ? Record<never, never>
          : RecursiveRequired<MapTypes<Extract<TArgNames, TCollectable>, Array<TType>, TNegatable>>)
...
> = undefined extends TArgNames
  ...
  : TArgNames extends `${infer Name}.${infer Rest}`
    ...
    : TArgNames extends string
      ? Partial<Record<TArgNames, TNegatable extends TArgNames ? TType | false : TType>>
      : Record<never, never>;
...
function get<TValue>(obj: Record<string, TValue>, key: string): TValue | undefined {
  if (hasOwn(obj, key)) {
    return obj[key];
  }
}
...
>(
  ...
  if (boolean !== undefined) {
    if (typeof boolean === 'boolean') {
      ...
      const booleanArgs: ReadonlyArray<string> = typeof boolean === 'string' ? [boolean] : boolean;
  ...
  if (string !== undefined) {
    const stringArgs: ReadonlyArray<string> = typeof string === 'string' ? [string] : string;
  ...
  if (collect !== undefined) {
    const collectArgs: ReadonlyArray<string> = typeof collect === 'string' ? [collect] : collect;
  ...
  function setKey(obj: NestedMapping, name: string, value: unknown, collect = true) {
    let o = obj;
