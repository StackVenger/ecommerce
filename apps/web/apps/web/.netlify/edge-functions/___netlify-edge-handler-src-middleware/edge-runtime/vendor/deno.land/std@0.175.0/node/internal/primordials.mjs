...
export const StringPrototypeCharCodeAt = (that, ...args) => that.charCodeAt(...args);
export const StringPrototypeEndsWith = (that, ...args) => that.endsWith(...args);
export const StringPrototypeIncludes = (that, ...args) => that.includes(...args);
...
export const StringPrototypeStartsWith = (that, ...args) => that.startsWith(...args);
