...
import __buffer$ from './buffer.ts';
import __string_decoder$ from './string_decoder.ts';
import __events$ from './events.ts';
...
var Ei = (e, t, n, r) => {
  if ((t && typeof t == 'object') || typeof t == 'function')
    for (let i of yi(t))
      !Si.call(e, i) &&
        i !== n &&
        Bt(e, i, { get: () => t[i], enumerable: !(r = wi(t, i)) || r.enumerable });
  return e;
};
var Ri = (e, t, n) => (
  (n = e != null ? pi(gi(e)) : {}),
  Ei(t || !e || !e.__esModule ? Bt(n, 'default', { value: e, enumerable: !0 }) : n, e)
);
var m = g((Yf, Gt) => {
  'use strict';
  Gt.exports = {
  ...
  N(
    ...
    (e, t, n) => {
      ...
      let i = [],
        ...
        l = [];
      for (let f of t)
        (X(typeof f == 'string', 'All expected entries have to be of type string'),
          Oi.includes(f)
            ? i.push(f.toLowerCase())
            : qi.test(f)
              ? o.push(f)
              : (X(f !== 'object', 'The value "object" should be written as "Object"'), l.push(f)));
      if (o.length > 0) {
    ...
    (e, t, n) => {
      ...
      return (
        Number.isInteger(n) && Math.abs(n) > 2 ** 32
          ? (r = Vt(String(n)))
          : typeof n == 'bigint'
            ? ((r = String(n)), (n > 2n ** 32n || n < -(2n ** 32n)) && (r = Vt(r)), (r += 'n'))
            : (r = Re(n)),
...
var V = g((Jf, _n) => {
  ...
  function yo(e, t) {
    return e == null
      ...
      : t === !0
        ...
        : t === !1
          ? typeof e[on] == 'function'
          : typeof e[rn] == 'function' || typeof e[on] == 'function';
  }
  function Ne(e) {
    if (!Q(e)) return null;
  ...
  function Eo(e, t) {
    return Q(e)
      ? Ne(e)
        ? !0
        : !((t?.readable !== !1 && dn(e)) || (t?.writable !== !1 && cn(e)))
      : null;
  }
  function Ro(e) {
    var t, n;
  ...
  function Mo(e) {
    var t;
    return !!(
      e && ((t = e[fn]) !== null && t !== void 0 ? t : e.readableDidRead || e.readableAborted)
    );
  }
  function No(e) {
    ...
    return !!(
      ...
      ((t =
        (n =
          (r =
            (i =
              (o = (l = e[an]) !== null && l !== void 0 ? l : e.readableErrored) !== null &&
              o !== void 0
                ? o
...
var Y = g((Qf, rt) => {
  ...
  function mn(e, t, n) {
    var r, i;
    (arguments.length === 2 ? ((n = t), (t = wn)) : t == null ? (t = wn) : Po(t, 'options'),
      Lo(n, 'callback'),
    ...
    (Fo(e)
      ? (e.on('complete', b), c || e.on('abort', _), e.req ? p() : e.on('request', p))
    ...
    return (
      ...
      async function* () {
        ...
        let l = new Nn(),
          ...
          c = { signal: a },
          s = () => l.abort();
        (t != null && (i = t.signal) !== null && i !== void 0 && i.aborted && s(),
          t == null || (o = t.signal) === null || o === void 0 || o.addEventListener('abort', s));
        let b,
          d,
          h = !1;
        function D() {
        ...
        async function L() {
          try {
            for await (let I of u) {
              ...
              I !== De &&
                (typeof ((_ = I) === null || _ === void 0 ? void 0 : _.catch) == 'function' &&
                  I.catch(D),
                f.push(I),
                b && (b(), (b = null)),
                !h &&
  ...
  async function il(e, t, n) {
    ...
    try {
      for await (let a of this) {
        var f;
        if (((u = !0), n != null && (f = n.signal) !== null && f !== void 0 && f.aborted))
          throw new $();
        i ? (t = await e(t, a, { signal: l })) : ((t = a), (i = !0));
      }
      if (!u && !i) throw new it();
    } finally {
      o.abort();
...
var Z = g((eu, vn) => {
  ...
  function Sl(e) {
    ...
    function n(r) {
      ...
      (i && (i.constructed = !0),
        o && (o.constructed = !0),
        l.destroyed ? e.emit(Wn, r) : r ? ut(e, r, !0) : K.nextTick(El, e));
    }
    try {
      e._construct(n);
    } catch (r) {
...
var ke = g((nu, Pe) => {
  ...
  Pe.exports.addAbortSignalNoValidate = function (e, t) {
    ...
    return (
      e.aborted
        ? n()
        : (e.addEventListener('abort', n), Ml(t, () => e.removeEventListener('abort', n))),
      t
    );
  };
});
  ...
  Hn.exports = class {
    ...
    *[Ol]() {
    ...
    _getBuffer(t) {
      ...
      do {
        ...
        if (t > l.length) (We(n, l, r - t), (t -= l.length));
          ...
          t === l.length
            ? (We(n, l, r - t), ++o, i.next ? (this.head = i.next) : (this.head = this.tail = null))
    ...
    [Symbol.for('nodejs.util.inspect.custom')](t, n) {
      return xl(this, { ...n, depth: 0, customInspect: !1 });
    }
  };
});
var Ce = g((ou, Kn) => {
...
var we = g((au, dr) => {
  ...
  var { EventEmitter: Ql } = __events$,
    ...
    ee = Jl('kPaused'),
    { StringDecoder: rr } = __string_decoder$,
    da = ct();
  ...
  function yt(e, t, n) {
    (typeof n != 'boolean' && (n = t instanceof v()),
      ...
      (this.highWaterMark = e ? ra(this, e, 'readableHighWaterMark', n) : ia(!1)),
      (this.buffer = new na()),
      (this.length = 0),
      (this.pipes = []),
      (this.flowing = null),
      ...
      (this.decoder = null),
      (this.encoding = null),
      e && e.encoding && ((this.decoder = new rr(e.encoding)), (this.encoding = e.encoding)));
  }
  function w(e) {
    ...
    if (
        ...
        (typeof t == 'string'
          ...
          : t instanceof ht
            ...
            : z._isUint8Array(t)
              ...
              : t != null && (o = new oa('chunk', ['string', 'Buffer', 'Uint8Array'], t))),
      o)
    )
      fe(e, o);
      ...
      if (r)
        ...
        ((i.reading = !1),
          i.decoder && !n
            ? ((t = i.decoder.write(t)),
              i.objectMode || t.length !== 0 ? _t(e, i, t, !1) : je(e, i))
            : _t(e, i, t, !1));
      }
  ...
  w.prototype.read = function (e) {
    ...
    if (
      ...
      (t.length === 0 || t.length - e < t.highWaterMark) &&
        ((r = !0), y('length less than watermark', r)),
      t.ended || t.reading || t.destroyed || t.errored || !t.constructed)
    )
      ((r = !1), y('reading, ended or constructing', r));
    else if (r) {
    ...
    return (
      ...
      i === null
        ...
        : ((t.length -= e),
          t.multiAwaitDrain ? t.awaitDrainWriters.clear() : (t.awaitDrainWriters = null)),
      t.length === 0 && (t.ended || (t.needReadable = !0), n !== e && t.ended && pt(this)),
      i !== null &&
        !t.errorEmitted &&
        !t.closeEmitted &&
  ...
  function $e(e) {
    ...
    (y('emitReadable', t.needReadable, t.emittedReadable),
      (t.needReadable = !1),
      t.emittedReadable ||
        (y('emitReadable', t.flowing), (t.emittedReadable = !0), W.nextTick(or, e)));
  }
  function or(e) {
    let t = e._readableState;
  ...
  w.prototype.pipe = function (e, t) {
    ...
    (r.pipes.length === 1 &&
      (r.multiAwaitDrain ||
        ((r.multiAwaitDrain = !0),
        (r.awaitDrainWriters = new zl(r.awaitDrainWriters ? [r.awaitDrainWriters] : [])))),
      r.pipes.push(e),
    ...
    function c() {
      (y('cleanup'),
        ...
        (a = !0),
        f && r.awaitDrainWriters && (!e._writableState || e._writableState.needDrain) && f());
    }
    function s() {
      (a ||
    ...
    return (
      e.emit('pipe', n),
      e.writableNeedDrain === !0 ? r.flowing && s() : r.flowing || (y('pipe resume'), n.resume()),
      e
    );
  };
  function pa(e, t) {
    return function () {
      ...
      (r.awaitDrainWriters === t
        ...
        : r.multiAwaitDrain &&
          (y('pipeOnDrain', r.awaitDrainWriters.size), r.awaitDrainWriters.delete(t)),
  ...
  w.prototype.resume = function () {
    let e = this._readableState;
    return (
      e.flowing || (y('resume'), (e.flowing = !e.readableListening), ya(this, e)),
      (e[ee] = !1),
      this
    );
  };
  ...
  function fr(e, t) {
    typeof e.read != 'function' && (e = w.wrap(e, { objectMode: !0 }));
    let n = Sa(e, t);
    return ((n.stream = e), n);
  }
...
var Tt = g((fu, Ar) => {
  ...
  function Se(e, t, n) {
    (typeof n != 'boolean' && (n = t instanceof v()),
      ...
      (this.highWaterMark = e ? Oa(this, e, 'writableHighWaterMark', n) : qa(!1)),
      (this.finalCalled = !1),
      (this.needDrain = !1),
      (this.ending = !1),
      (this.ended = !1),
  ...
  function Sr(e, t, n, r) {
    ...
    let o;
    return (
      i.ending ? (o = new Ca()) : i.destroyed && (o = new ge('write')),
      o ? (te.nextTick(r, o), se(e, o, !0), o) : (i.pendingcb++, ja(e, i, t, n, r))
    );
  }
  ...
  S.prototype.end = function (e, t, n) {
    ...
    return (
      ...
      i ||
        (!r.errored && !r.ending
          ? ((r.ending = !0), mt(this, r, !0), (r.ended = !0))
          : r.finished
            ? (i = new ka('end'))
            : r.destroyed && (i = new ge('end'))),
      typeof n == 'function' && (i || r.finished ? te.nextTick(n, i) : r[de].push(n)),
      this
    );
  };
  function Fe(e) {
  ...
  function Fa(e, t) {
    ...
    function r(i) {
      ...
      if (((n = !0), t.pendingcb--, i)) {
        ...
        Fe(t) && ((t.prefinished = !0), e.emit('prefinish'), t.pendingcb++, te.nextTick(St, e, t));
    }
  ...
  S.prototype.destroy = function (e, t) {
    let n = this._writableState;
    return (
      !n.destroyed && (n.bufferedIndex < n.buffered.length || n[de].length) && te.nextTick(Rt, n),
      Ba.call(this, e, t),
      this
    );
  };
...
var kr = g((uu, Pr) => {
  ...
  Pr.exports = function e(t, n) {
    ...
    if (Ya(t)) return Ge({ writable: !1, readable: !1 });
    if (typeof t == 'function') {
      let { value: i, write: o, final: l, destroy: u } = ef(t);
      if (mr(i)) return Or(ne, i, { objectMode: !0, write: o, final: l, destroy: u });
      let f = i?.then;
    ...
    if (mr(t)) return Or(ne, t, { objectMode: !0, writable: !1 });
    ...
    if (typeof r == 'function') {
      ...
      return (
        ...
        (i = new ne({ objectMode: !0, writable: !1, read() {} }))
      );
    }
    throw new za(
      n,
  ...
  function ef(e) {
    ...
    return {
      value: e(
        (async function* () {
          for (;;) {
            ...
            if (i.aborted) throw new Lr(void 0, { cause: i.reason });
      ...
      write(l, u, f) {
        let a = n;
        ((n = null), a({ chunk: l, done: !1, cb: f }));
      },
      final(l) {
        let u = n;
        ((n = null), u({ done: !0, cb: l }));
      },
      destroy(l, u) {
        (r.abort(), u(l));
      },
...
var v = g((su, jr) => {
  ...
  tf(C.prototype, {
    ...
    writableHighWaterMark: { __proto__: null, ...B(x.prototype, 'writableHighWaterMark') },
    writableObjectMode: { __proto__: null, ...B(x.prototype, 'writableObjectMode') },
    writableBuffer: { __proto__: null, ...B(x.prototype, 'writableBuffer') },
    writableLength: { __proto__: null, ...B(x.prototype, 'writableLength') },
    writableFinished: { __proto__: null, ...B(x.prototype, 'writableFinished') },
    writableCorked: { __proto__: null, ...B(x.prototype, 'writableCorked') },
    writableEnded: { __proto__: null, ...B(x.prototype, 'writableEnded') },
    writableNeedDrain: { __proto__: null, ...B(x.prototype, 'writableNeedDrain') },
    destroyed: {
      __proto__: null,
      get() {
...
var xt = g((du, vr) => {
  ...
  G.prototype._write = function (e, t, n) {
    ...
    this._transform(e, t, (l, u) => {
      ...
      (u != null && this.push(u),
        i.ended || o === r.length || r.length < r.highWaterMark ? n() : (this[Ee] = n));
    });
  };
    ...
    for (let _ = 0; _ < e.length; _++) {
      ...
      if (_ === 0)
        ...
        if (((h = Rf(h)), (h = p(h, { signal: i })), I)) {
          ...
          else if (be(h, !0)) (s++, Vr(h, P, b, { end: F }));
...
var ei = g((bu, Zr) => {
  ...
  Zr.exports = function (...t) {
    ...
    let n = [...t];
    if (
      (typeof t[0] == 'function' && (t[0] = Ke.from(t[0])), typeof t[t.length - 1] == 'function')
    ) {
      let d = t.length - 1;
      t[d] = Ke.from(t[d]);
    }
...
export {
  ...
  mu as Writable,
  gu as _isUint8Array,
  yu as _uint8ArrayToBuffer,
  Nu as addAbortSignal,
  xu as compose,
  Pu as default,
  Ou as destroy,
  Du as finished,
