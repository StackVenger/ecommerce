...
function addReadOnlyProcessAlias(name: string, option: string, enumerable = true) {
...
export function emitWarning(
  ...
  type: // deno-lint-ignore ban-types
    { type: string; detail: string; code: string; ctor: Function } | string | null,
  code?: string,
  // deno-lint-ignore ban-types
  ctor?: Function,
) {
...
class Process extends EventEmitter {
  ...
  override prependListener(event: 'exit', listener: (code: number) => void): this;
  ...
  override removeListener(event: 'exit', listener: (code: number) => void): this;
