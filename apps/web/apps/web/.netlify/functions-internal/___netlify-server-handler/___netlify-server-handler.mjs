...
} from '/var/task/apps/web/.netlify/dist/run/handlers/request-context.cjs';
import {
  getTracer,
  withActiveSpan,
} from '/var/task/apps/web/.netlify/dist/run/handlers/tracer.cjs';

process.chdir('/var/task/apps/web');
    ...
    return withActiveSpan(tracer, 'Next.js Server Handler', async (span) => {
      ...
      if (!cachedHandler) {
        const { default: handler } =
          await import('/var/task/apps/web/.netlify/dist/run/handlers/server.js');
